...
// Giả sử bạn đã có session user_id và cart_id
...
// Tạo đơn hàng
$sql_insert_order = "INSERT INTO orders (cart_id, user_id, order_date, total_price, status) VALUES (?, ?, NOW(), ?, 'Chờ duyệt')";
...
if ($insert_stmt->affected_rows > 0) {
    ...
    echo "<p><a href='order_detail.php?id=$order_id'>Xem chi tiết đơn hàng</a></p>";
